...
function runMigrations(db) {
  ...
  if (menuSeedVersion < targetMenuSeedVersion) {
    ...
    const seedItems = [
      ...
      { id: 'item-011', name: 'Roti', desc: '', price: 15, halfPrice: null, catId: 'cat-01' },
      { id: 'item-012', name: 'Regular', desc: '', price: 70, halfPrice: null, catId: 'cat-02' },
      { id: 'item-013', name: 'Drink-1 Liter', desc: '', price: 170, halfPrice: null, catId: 'cat-02' },
      { id: 'item-014', name: 'Drink-1.5 Liter', desc: '', price: 200, halfPrice: null, catId: 'cat-02' },
      { id: 'item-015', name: 'Drink-2.5 Liter', desc: '', price: 240, halfPrice: null, catId: 'cat-02' },
