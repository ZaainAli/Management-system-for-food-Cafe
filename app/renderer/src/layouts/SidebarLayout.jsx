...
const navItems = [
  ...
  { path: '/reports/export', label: 'Export', icon: 'M4 16v2a2 2 0 002 2h12a2 2 0 002-2v-2M7 10l5 5m0 0l5-5m-5 5V4', permission: 'canAccessReports' },
  { path: '/reports/discount', label: 'Discount Report', icon: 'M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A2 2 0 013 12V7a4 4 0 014-4z', permission: 'canAccessReports' },
