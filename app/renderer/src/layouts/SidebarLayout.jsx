...
const navItems = [ 
  ...
  { path: '/menu',      label: 'Menu',       icon: 'M4 6h16M4 12h16M4 18h10', permission: 'canManageMenu' },
  ...
  { path: '/khata',     label: 'Khata (Ledger)', icon: 'M4 4h16M4 8h16M4 12h10M4 16h16M4 20h10', permission: 'canAccessKhata' },
  ...
  { path: '/attendance', label: 'Attendance', icon: 'M9 12l2 2 4-4m5 2a9 9 0 11-18 0 9 9 0 0118 0z', permission: 'canAccessAttendance' },
  ...
  { path: '/reports/recent-bills', label: 'Last 20 Bills', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l3.414 3.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', permission: 'canAccessBillHistory' },
  { path: '/reports/export', label: 'Export', icon: 'M4 16v2a2 2 0 002 2h12a2 2 0 002-2v-2M7 10l5 5m0 0l5-5m-5 5V4', permission: 'canAccessExportReports' },
  { path: '/reports/discount', label: 'Table & Discount Report', icon: 'M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A2 2 0 013 12V7a4 4 0 014-4z', permission: 'canAccessDiscountReports' },
  ...
  { path: '/branch',    label: 'Branch',     icon: 'M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z', permission: 'canAccessDashboard' },
];
        ...
        <div className="h-full flex flex-col px-3 py-4 overflow-y-auto bg-slate-800 border-r border-slate-700">
          ...
          <div className="px-2 py-4 mb-2">
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-white font-semibold text-sm">Hamza & Brother's Food Chain</span>
            </div>
          </div>
